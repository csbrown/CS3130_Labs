...
### Question 2
  Open the R interpreter now, and execute `install.packages("ggplot2")`.  This will install the `ggplot2` package.  *confirm that you have successfully installed the `rmarkdown` package*
