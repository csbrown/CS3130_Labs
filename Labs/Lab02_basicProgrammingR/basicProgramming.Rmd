...
<!-- ### READ IT LATER: More Vectorization -->
...
<!-- Lastly, we could use the `filter` and `select` functions from the `dplyr` package which introduces the `%>%` operator from the `magrittr` package. The below code will  -->
