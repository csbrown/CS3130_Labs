...
Now suppose Albert had no idea whether `Getting an A on the First exam` and `Liking Cilantro` were independent in the population of 2021 CS 3130 students. He wanted to determine this. So he collected information from a simple random sample of 12 students. The data from these students is given below
