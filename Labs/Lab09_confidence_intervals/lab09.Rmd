...
Also, the [algebra of convergence in distribution](https://en.wikipedia.org/wiki/Slutsky%27s_theorem) justifies replacing $\sigma^2$
...
If you know the exact distribution of a statistic, it is better to use it (rather than an approximation like the CLT) to construct the confidence interval. It turns out that time spent alone is highly non symmetric, so we needed the CLT here. 
