...
At this point it is worthwhile to take mental notes of both the limiations and benefits of the study procedure.
...
## Question 10: Murphy hopes that if $\mu \geq 85$, then he should reject with high probability. Using the appoximation for $P(Reject)$ given in question 9, what is the approximate rejection probability when $\mu = 85$? (Recall his planned testing procedure has $n=30$ and $x = 85$). Assume $\sigma = 10$ to answer this question.

You tell Murphy the number from question $10$ and he says great. . But what about if $\mu > 85$? Question 11 helps us answer this question.

## Question 11: Let $\mu_1 = 85$ and $\mu_2 > 85$. Is the approximate rejection probability under $\mu = \mu_2$ greater than, equal to, or less than the approximate rejection probability when $\mu = \mu_1$ (when $n$ and $x$ are given)?
