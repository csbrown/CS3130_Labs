...
## Question 8: Are these variables still strongly correlated?
...
## Question 9: Is our response correlated with our predictors?

## Question 10: Are our two predictors correlated?

In the next question, rely on your "real-world" understanding of what a "county" is, what "median income" means, and what "poverty" means.

## Question 11: In your opinion, does "Median Income" convey information about a community that "Poverty rate" does not?  i.e. do you "know more" about a community by having *both* of these pieces of info rather than just one?
...
```
```{r}
# NOTE: Your variable names may be different at this point.
head(povincpopcancer)
model1 <- lm(age_adjusted_incidence_rate_e_cases_per_100_000 ~ b19013_001, data=povincpopcancer)
summary(model1)
```

## Question 12: If Community 1 has a median income that is $\$5000$ greater than Community 2, what change does our model predict in the number of cancer cases per 100,000?
...
## Question 13: Which of these two predictors has the strongest correlation with your response variable?
...
For Question 14, recall that:

$$ R^2 := 1 - \frac{\text{Var}(\text{Residual})}{\text{Var}(Y)} $$

## Question 14: How much **more** of the variance in cancer incidence is "accounted for" by including both variables, instead of just "Median Income"?
...
## Question 15: Based on this, does Poverty Rate seem to be informative of Cancer Incidence?  After taking Median Income into account, does Poverty Rate seem to add any additional information about Cancer Incidence?
